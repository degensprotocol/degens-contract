// Original version from: https://github.com/bokkypoobah/Tokens/blob/master/contracts/FixedSupplyToken.sol
...
contract TestToken is ERC20Interface, Owned {
    ...
    // Special functions used for testing Degens contract

    bool transferFail = false;
    bool transferReturnFalse = false;
    bool transferFromFail = false;
    bool transferFromReturnFalse = false;

    function setTransferFail(bool status) public { transferFail = status; }
