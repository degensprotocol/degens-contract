...

{
  ...
  actions: [
    ...
    { action: 'order', from: 'B', amount: 500, dir: 'sell', price: 40, orderId: 2, expiryOffset: 30, },
    { action: 'order', from: 'B', amount: 500, dir: 'sell', price: 30, orderId: 3, expiryOffset: 60, },

    { action: 'increase-time', amount: 40, },
...

{
  ...
  actions: [
    ...
    { action: 'order', from: 'A', amount: 1000, dir: 'buy', price: 60, orderId: 1, expiryOffset: 30, },
    { action: 'order', from: 'B', amount: 500, dir: 'sell', price: 40, orderId: 2, expiryOffset: 60, },
    { action: 'order', from: 'B', amount: 500, dir: 'sell', price: 30, orderId: 3, expiryOffset: 60, },
