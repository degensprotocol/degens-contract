...

{
  ...
  actions: [
    ...
    { action: 'trade', from: 'C', orderIds: [2], amount: 5000, },
...

{
  ...
  actions: [
    ...
    { action: 'trade', from: 'C', orderIds: [3], amount: 5000, },
...

{
  ...
  actions: [
    ...
    { action: 'trade', from: 'B', orderIds: [1], amount: 29764, },

    { action: 'order', from: 'B', amount: 100000, dir: 'buy', price: 82, orderId: 2, },
    { action: 'trade', from: 'C', orderIds: [2], amount: 61215, },

    { action: 'order', from: 'C', amount: 100000, dir: 'buy', price: 29, orderId: 3, },
    { action: 'trade', from: 'A', orderIds: [3], amount: 75261, },
...

{
  ...
  actions: [
    ...
    { action: 'deposit', from: 'A', amount: testlib.toWei("1"), },
    { action: 'deposit', from: 'B', amount: testlib.toWei("1"), },
    { action: 'deposit', from: 'C', amount: testlib.toWei("1"), },

    { action: 'order', from: 'A', amount: testlib.toWei("1"), dir: 'sell', price: 55, orderId: 1, },
    { action: 'trade', from: 'B', orderIds: [1], amount: testlib.toWei("0.2"), },

    { action: 'order', from: 'A', amount: testlib.toWei("1"), dir: 'buy', price: 45, orderId: 2, },
    { action: 'trade', from: 'B', orderIds: [2], amount: testlib.toWei(".07"), },
